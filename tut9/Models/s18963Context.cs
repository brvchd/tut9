...
{
    public partial class s18963Context : DbContext
    {
        public s18963Context()
        {
        }

        public s18963Context(DbContextOptions<s18963Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18963;Integrated Security=True");
            }
        }
